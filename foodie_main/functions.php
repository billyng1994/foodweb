...
function infinite_scroll() {
    ...
    while( $loop->have_posts() ) {
        ...
        echo print_title(get_the_title($loop->post->ID),30, '<h2 style="padding: 5px 0; margin: 5px 0;">','</h2>') ;
        echo '</a>';
        echo '<div style="padding: 0.1rem 0">'. get_the_category($loop->post->ID)[0]->name .'</div>';
